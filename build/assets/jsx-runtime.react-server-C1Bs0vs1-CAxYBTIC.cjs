...
function requireReactJsxRuntime_reactServer_production() {
  ...
  var React = ssr.requireReact_reactServer(), REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment");
...
function requireReactJsxRuntime_reactServer_development() {
  ...
  "production" !== process.env.NODE_ENV && function() {
    ...
    var React = ssr.requireReact_reactServer(), REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler");
...
exports.jsxRuntime_reactServerExports = jsxRuntime_reactServerExports;
